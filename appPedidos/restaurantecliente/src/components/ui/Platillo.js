...
const Platillo = ({ platillo }) => {
  ...
  //Contex de firebase para cambios en la base de datos
        ...
        <div className='lg:flex'>
          <div className='lg:w-5/12 xl:w-3/12'>
            ...
            <div className='sm:flex sm:-mx-2 pl-2'>
              <label className='block mt-5 sm:w-2/3'>
                <span className='block text-gray-800 mb-2'>Existencia</span>

                <select
                  className='bg-white shadow appearance-none border rounded w-full
          ...
          <div className='lg:w-7/12 xl:w-9/12 pl-5'>
            ...
            <p className='text-gray-600 mb-4'>Categoría: {' '}
              <span className='text-gray-700 font-bold capitalize'>{categoria}</span>
            </p>
